...
public void user_is_logged_into_the_website() throws InterruptedException {
...
//   pp.Name(name);
	...
	driver.findElement(By.xpath("(/html/body/div[1]/div/div[4]/div[1]/div[4]/form/div[1]/div[3]/div[1]/div[1]/input")).sendKeys(name);
